...
class TestMult(unittest.TestCase):
    ...
    def test_mult1(self):
        self.assertEqual(Calculadora.multiplicacao(None, 2),
                         'É necessário passar dois valores no parametro de entrada!')

    def test_mult2(self):
        self.assertEqual(Calculadora.multiplicacao(2, None),
                         'É necessário passar dois valores no parametro de entrada!')
